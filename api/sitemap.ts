...
export default async function handler(req: any, res: any) {
  ...
  const staticPages = [
    ...
    { url: "/category/ambition", priority: "0.8", changefreq: "daily" },
    { url: "/category/discipline", priority: "0.8", changefreq: "daily" },
    { url: "/category/money", priority: "0.8", changefreq: "daily" },
    { url: "/category/financial_freedom", priority: "0.8", changefreq: "daily" },
    { url: "/category/family", priority: "0.8", changefreq: "daily" },
    { url: "/category/goals", priority: "0.8", changefreq: "daily" },
    { url: "/category/mindset", priority: "0.8", changefreq: "daily" },
